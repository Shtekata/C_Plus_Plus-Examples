...
static void randToFile(int& a, int& b, int& c) {
  ...
  ofstream randNumFile("d:/randomNumbers.txt");
  for (int i = 0; i < a; i++) {
    stringstream sstr;
...
static void fileToVector(string& a, vector<string>& b) {
  ifstream randNumFile("d:/randomNumbers.txt");
...
static void analyze(int& a, int& b, vector<string>& c) {
  int perc__0_10Count = 0;
  int perc_10_20Count = 0;
  int perc_20_30Count = 0;
  int perc_30_40Count = 0;
  int perc_40_50Count = 0;
  int perc_50_60Count = 0;
  int perc_60_70Count = 0;
  int perc_70_80Count = 0;
  int perc_80_90Count = 0;
  int perc90_100Count = 0;
  double tempUnit = (b - a) / 10.0;
  double tempNum = 0;
  ofstream percFile("d:/percentages.txt");

  for (string number : c) {
    tempNum = stod(number);
    if (tempNum < tempUnit + a) {
      cout << "Row: _0_10 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit + a) << "\n\n";
      percFile << "Row: _0_10 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit + a) << "\n\n";
      perc__0_10Count++;
    } else if (tempNum < tempUnit * 2 + a) {
      cout << "Row: 10_20 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 2" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 2 + a) << "\n\n";
      percFile << "Row: 10_20 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 2" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 2 + a) << "\n\n";
      perc_10_20Count++;
    } else if (tempNum < tempUnit * 3 + a) {
      cout << "Row: 20_30 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 3" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 3 + a) << "\n\n";
      percFile << "Row: 20_30 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 3" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 3 + a) << "\n\n";
      perc_20_30Count++;
    } else if (tempNum < tempUnit * 4 + a) {
      cout << "Row: 30_40 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 4" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 4 + a) << "\n\n";
      percFile << "Row: 30_40 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 4" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 4 + a) << "\n\n";
      perc_30_40Count++;
    } else if (tempNum < tempUnit * 5 + a) {
      cout << "Row: 40_50 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 5" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 5 + a) << "\n\n";
      percFile << "Row: 40_50 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 5" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 5 + a) << "\n\n";
      perc_40_50Count++;
    } else if (tempNum < tempUnit * 6 + a) {
      cout << "Row: 50_60 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 6" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 6 + a) << "\n\n";
      percFile << "Row: 50_60 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 6" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 6 + a) << "\n\n";
      perc_50_60Count++;
    } else if (tempNum < tempUnit * 7 + a) {
      cout << "Row: 60_70 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 7" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 7 + a) << "\n\n";
      percFile << "Row: 60_70 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 7" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 7 + a) << "\n\n";
      perc_60_70Count++;
    } else if (tempNum < tempUnit * 8 + a) {
      cout << "Row: 70_80 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 8" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 8 + a) << "\n\n";
      percFile << "Row: 70_80 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 8" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 8 + a) << "\n\n";
      perc_70_80Count++;
    } else if (tempNum < tempUnit * 9 + a) {
      cout << "Row: 80_90 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum << " < "
           << tempUnit << " * 9" << " + " << a << " | " << boolalpha
           << (tempNum < tempUnit * 9 + a) << "\n\n";
      percFile << "Row: 80_90 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum << " < "
               << tempUnit << " * 9" << " + " << a << " | " << boolalpha
               << (tempNum < tempUnit * 9 + a) << "\n\n";
      perc_80_90Count++;
    } else if (tempNum <= tempUnit * 10 + a) {
      cout << "Row: 90_100 " << "tempNum: " << tempNum
           << " tempUnit: " << tempUnit << " | " << tempNum
           << " <= " << tempUnit << " * 10" << " + " << a << " | "
           << boolalpha << (tempNum <= tempUnit * 10 + a) << "\n\n";
      percFile << "Row: 90_100 " << "tempNum: " << tempNum
               << " tempUnit: " << tempUnit << " | " << tempNum
               << " <= " << tempUnit << " * 10" << " + " << a << " | "
               << boolalpha << (tempNum <= tempUnit * 10 + a) << "\n\n";
      perc90_100Count++;
  ...
  double allPercCount = perc__0_10Count + perc_10_20Count + perc_20_30Count +
                        perc_30_40Count + perc_40_50Count + perc_50_60Count +
                        perc_60_70Count + perc_70_80Count + perc_80_90Count +
                        perc90_100Count;
